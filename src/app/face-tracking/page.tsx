...
import FaceTracker from '../../components/face/FaceTracker';
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      <div className="container mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-300 mb-4">カメラの前で顔を動かして、リアルタイムで顔ランドマークを検出します。</p>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="md:w-2/3 bg-gray-800 rounded-lg overflow-hidden shadow-lg"
            ...
            <FaceTracker width={640} height={480} glowSize={12} />
          </div>
          <div className="md:w-1/3 space-y-6">
            <div className="bg-gray-800 p-4 rounded-lg border border-purple-500"
              ...
              <ul className="space-y-2 text-sm list-disc pl-5 text-cyan-100">
                ...
                <li>顔がカメラにしっかり映るようにしてください</li>
                <li>表情や顔の向きを変えてみてください</li>
            ...
            <div className="bg-gray-800 p-4 rounded-lg border border-purple-500"
              ...
              <p className="text-sm text-cyan-100">顔ランドマークはサイバーパンク風の色とグローで表示されます。</p>
            </div>
          </div>
        </div>
      </div>
